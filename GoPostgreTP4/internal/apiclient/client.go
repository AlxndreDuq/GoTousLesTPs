...
func (c *Client) CreateNote(ctx context.Context, title, content string) (core.Note, error) {
	env, err := c.do(ctx, http.MethodPost, "/api/v1/notes", createNoteRequest{Title: title, Content: content})
	if err != nil {
